...
@Component({
  ...
  <div class="col-12 col-sm-12 col-md-2 text-center">
          <img class="img-responsive" src="{{product.Picture}}" alt="prewiew" width="120" height="80">
  </div>
  ...
  <div class="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
      ...
      <div > 
        <button type="button" class="btn btn-primary btn-sm" (click)="like()">{{Like}} {{product.LikeCount}}</button>
      </div>
